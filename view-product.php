...
<body>
	...
	<div class="show-case-info">
		...
		<div class="btn btn-success" <?php if(isset($_SESSION['u_id'])) { ?> onclick="addToCart(<?=$id?>)" <?php } ?>>Add to cart</div>
